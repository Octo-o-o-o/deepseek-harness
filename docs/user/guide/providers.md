...
This guide assumes you started the Web UI through the [root README](../../../README.en.md#run-from-npm). Model changes take effect on the next request without restarting the server.
