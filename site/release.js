/* DSHD 官网下载配置 —— 全站唯一需要改的发布常量。
   ...
   同一批文件在 GitHub Releases 亦有分发:
     https://github.com/Octo-o-o-o/deepseek-harness-desktop/releases/tag/dshd-v0.1.13

   macOS 0.1.13 构建自 349b5c4bcd(上游 0.1.1-rc.1)。Windows 安装器仍是上一轮
   e1cc57dc0f 的 0.1.0 包,本版未重打。

   SHA-256(与 GitHub Release 页所列一致,供用户核对下载完整性):
     dshd-0.1.13-arm64.dmg     70b33f8ae31f5e548006262a0c43bda242492d30a41b5cdc69acd28ee0fdd566
...
window.RELEASE = {
  VERSION: "v0.1.13",
  MAC: "https://dshd-dl.octoooo.com/v0.1.13/349b5c4b/dshd-0.1.13-arm64.dmg", // macOS Apple Silicon(.dmg)
